...
/*----------------*/
    ...
    std::string KnowledgeBase::toString(const rosplan_knowledge_msgs::KnowledgeItem& item) {
        if (item.knowledge_type == rosplan_knowledge_msgs::KnowledgeItem::INSTANCE) {
            return item.instance_name;
        } else if (item.knowledge_type == rosplan_knowledge_msgs::KnowledgeItem::FACT) {
