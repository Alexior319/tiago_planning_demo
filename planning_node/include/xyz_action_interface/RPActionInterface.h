...
namespace KCL_rosplan {
    ...
    protected:
        ...
        std::map<std::string, rosplan_knowledge_msgs::DomainFormula>
                sensed_predicates;
    ...
    public:
        ...
        void
        dispatchCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr &msg);

        /* perform or call real action implementation */
        virtual bool concreteCallback(
                const rosplan_dispatch_msgs::ActionDispatch::ConstPtr &msg) = 0;
    };
} // namespace KCL_rosplan
#endif
