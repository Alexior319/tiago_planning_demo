...
/* get domain name */
    bool XYZKnowledgeBase::getDomainName(xyz_knowledge_msgs::GetDomainNameService::Request& req,
...
/* get domain types */
    bool XYZKnowledgeBase::getTypes(xyz_knowledge_msgs::GetDomainTypeService::Request& req,
                                    xyz_knowledge_msgs::GetDomainTypeService::Response& res) {
        res.types = types;
        return true;
    }

    bool XYZKnowledgeBase::getGoals(xyz_knowledge_msgs::GetAttributeService::Request& req,
...
/* get domain predicates */
    bool XYZKnowledgeBase::getPredicates(xyz_knowledge_msgs::GetDomainAttributeService::Request& req,
...
/* get domain operators */
    bool XYZKnowledgeBase::getOperators(xyz_knowledge_msgs::GetDomainOperatorService::Request& req,
...
/* get domain operator details */
    bool XYZKnowledgeBase::getOperatorDetails(xyz_knowledge_msgs::GetDomainOperatorDetailsService::Request& req,
...
/* get domain predicate details */
    bool XYZKnowledgeBase::getPredicateDetails(xyz_knowledge_msgs::GetDomainPredicateDetailsService::Request& req,
...
/* get the initial state from the domain and problem files */
    ...
    bool XYZKnowledgeBase::getCurrent(xyz_knowledge_msgs::GetAttributeService::Request& req,
                                      xyz_knowledge_msgs::GetAttributeService::Response& res) {
    ...
    const vector<xyz_knowledge_msgs::KnowledgeItem>& XYZKnowledgeBase::getState() const {
        return model_facts;
    }
