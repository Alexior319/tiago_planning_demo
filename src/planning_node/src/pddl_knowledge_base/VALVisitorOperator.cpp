...
//
#include "pddl_knowledge_base/VALVisitorOperator.h"
...
namespace planning_node {
    ...
    void VALVisitorOperator::visit_simple_goal(VAL1_2::simple_goal *c) {
        ...
        if (cond_neg) {
            switch (cond_time) {
                case VAL1_2::E_AT_START:
                    msg.at_start_neg_condition.push_back(last_prop);
                    break;
                case VAL1_2::E_AT_END:
                    msg.at_end_neg_condition.push_back(last_prop);
                    break;
                case VAL1_2::E_OVER_ALL:
                    msg.over_all_neg_condition.push_back(last_prop);
                    break;
            }
        } else {
            switch (cond_time) {
                case VAL1_2::E_AT_START:
                    msg.at_start_simple_condition.push_back(last_prop);
                    break;
                case VAL1_2::E_AT_END:
                    msg.at_end_simple_condition.push_back(last_prop);
                    break;
                case VAL1_2::E_OVER_ALL:
                    msg.over_all_simple_condition.push_back(last_prop);
                    break;
            }
        }
    }
    ...
    void VALVisitorOperator::visit_comparison(VAL1_2::comparison *c) {
        ...
        xyz_knowledge_msgs::DomainInequality ineq;
        ineq.grounded = false;
        ...
        // assignment operator
        switch (c->getOp()) {
            case VAL1_2::E_GREATER:
                ineq.comparison_type = xyz_knowledge_msgs::DomainInequality::GREATER;
                break;
            case VAL1_2::E_GREATEQ:
                ineq.comparison_type = xyz_knowledge_msgs::DomainInequality::GREATEREQ;
                break;
            case VAL1_2::E_LESS:
                ineq.comparison_type = xyz_knowledge_msgs::DomainInequality::LESS;
                break;
            case VAL1_2::E_LESSEQ:
                ineq.comparison_type = xyz_knowledge_msgs::DomainInequality::LESSEQ;
                break;
            case VAL1_2::E_EQUALS:
                ineq.comparison_type = xyz_knowledge_msgs::DomainInequality::EQUALS;
                break;
        }

        switch (cond_time) {
            case VAL1_2::E_AT_START:
                msg.at_start_comparison.push_back(ineq);
                break;
            case VAL1_2::E_AT_END:
                msg.at_end_comparison.push_back(ineq);
                break;
            case VAL1_2::E_OVER_ALL:
                msg.over_all_comparison.push_back(ineq);
                break;
        }
    }
    ...
    void VALVisitorOperator::visit_simple_effect(VAL1_2::simple_effect *e) {
        ...
        if (eff_neg) {
            switch (eff_time) {
                case VAL1_2::E_AT_START:
                    msg.at_start_del_effects.push_back(last_prop);
                    break;
                case VAL1_2::E_AT_END:
                    msg.at_end_del_effects.push_back(last_prop);
                    break;
            }
        } else {
            switch (eff_time) {
                case VAL1_2::E_AT_START:
                    msg.at_start_add_effects.push_back(last_prop);
                    break;
                case VAL1_2::E_AT_END:
                    msg.at_end_add_effects.push_back(last_prop);
                    break;
            }
        }
    }
    ...
    void VALVisitorOperator::visit_assignment(VAL1_2::assignment *e) {
        ...
        xyz_knowledge_msgs::DomainAssignment ass;
        ass.grounded = false;
        ...
        // assignment operator
        switch (e->getOp()) {
            case VAL1_2::E_ASSIGN:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::ASSIGN;
                break;
            case VAL1_2::E_INCREASE:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::INCREASE;
                break;
            case VAL1_2::E_DECREASE:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::DECREASE;
                break;
            case VAL1_2::E_SCALE_UP:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::SCALE_UP;
                break;
            case VAL1_2::E_SCALE_DOWN:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::SCALE_DOWN;
                break;
            case VAL1_2::E_ASSIGN_CTS:
                ass.assign_type = xyz_knowledge_msgs::DomainAssignment::ASSIGN_CTS;
                break;
        }
        ...
        switch (eff_time) {
            case VAL1_2::E_AT_START:
                msg.at_start_assign_effects.push_back(ass);
                break;
            case VAL1_2::E_AT_END:
                msg.at_end_assign_effects.push_back(ass);
                break;
        }
    }

    void VALVisitorOperator::visit_forall_effect(VAL1_2::forall_effect *e) {
        std::cout << "not implemented forall" << std::endl;
    };

    void VALVisitorOperator::visit_cond_effect(VAL1_2::cond_effect *e) {
    ...
    void VALVisitorOperator::visit_plus_expression(VAL1_2::plus_expression *s) {
        ...
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        op.op = xyz_knowledge_msgs::ExprBase::ADD;
    ...
    void VALVisitorOperator::visit_minus_expression(VAL1_2::minus_expression *s) {
        ...
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        op.op = xyz_knowledge_msgs::ExprBase::SUB;
        last_expr.tokens.push_back(op);
    ...
    void VALVisitorOperator::visit_mul_expression(VAL1_2::mul_expression *s) {
        ...
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        op.op = xyz_knowledge_msgs::ExprBase::MUL;
        last_expr.tokens.push_back(op);
    ...
    void VALVisitorOperator::visit_div_expression(VAL1_2::div_expression *s) {
        ...
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        op.op = xyz_knowledge_msgs::ExprBase::DIV;
        last_expr.tokens.push_back(op);
    ...
    void VALVisitorOperator::visit_uminus_expression(VAL1_2::uminus_expression *s) {
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        op.op = xyz_knowledge_msgs::ExprBase::UMINUS;
        last_expr.tokens.push_back(op);
    }

    void VALVisitorOperator::visit_int_expression(VAL1_2::int_expression *s) {
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::CONSTANT;
    ...
    void VALVisitorOperator::visit_special_val_expr(VAL1_2::special_val_expr *s) {
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::SPECIAL;
        switch (s->getKind()) {
            case VAL1_2::E_HASHT:
                op.special_type = xyz_knowledge_msgs::ExprBase::HASHT;
                break;
            case VAL1_2::E_DURATION_VAR:
                op.special_type = xyz_knowledge_msgs::ExprBase::DURATION;
                break;
            case VAL1_2::E_TOTAL_TIME:
                op.special_type = xyz_knowledge_msgs::ExprBase::TOTAL_TIME;
                break;
        }
        last_expr.tokens.push_back(op);
    }
    ...
    void VALVisitorOperator::visit_func_term(VAL1_2::func_term *s) {
        xyz_knowledge_msgs::ExprBase op;
        op.expr_type = xyz_knowledge_msgs::ExprBase::FUNCTION;
        ...
        for (VAL1_2::parameter_symbol_list::const_iterator vi = s->getArgs()->begin();
             vi != s->getArgs()->end(); vi++) {
            diagnostic_msgs::KeyValue param;
