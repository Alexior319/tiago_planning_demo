...
#include "pddl_knowledge_base/VALVisitorProblem.h"
...
namespace planning_node {
    ...
    std::vector<xyz_knowledge_msgs::KnowledgeItem> VALVisitorProblem::returnFacts() {
        if (!effects_read) {
    ...
    std::vector<xyz_knowledge_msgs::KnowledgeItem> VALVisitorProblem::returnFunctions() {
        if (!effects_read) {
            visit_effect_lists(problem->initial_state);
            effects_read = true;
        }
    ...
    std::vector<xyz_knowledge_msgs::KnowledgeItem> VALVisitorProblem::returnGoals() {
        problem->the_goal->visit(this);
        return goals;
    }

    xyz_knowledge_msgs::KnowledgeItem VALVisitorProblem::returnMetric() {
        problem->metric->visit(this);
        return metric;
    }

    std::vector<xyz_knowledge_msgs::KnowledgeItem> VALVisitorProblem::returnTimedKnowledge() {
        if (!effects_read) {
            visit_effect_lists(problem->initial_state);
            effects_read = true;
        }
    ...
    void VALVisitorProblem::visit_proposition(VAL1_2::proposition *p) {
        ...
        for (VAL1_2::pred_decl_list::const_iterator predicateIterator = predicates->begin();
    ...
    void VALVisitorProblem::visit_assignment(VAL1_2::assignment *e) {
        ...
        xyz_knowledge_msgs::KnowledgeItem item;
        item.knowledge_type = xyz_knowledge_msgs::KnowledgeItem::FUNCTION;
        ...
        item.function_value = KCL_rosplan::KnowledgeComparitor::evaluateExpression(last_expr, functions);
    ...
    void VALVisitorProblem::visit_forall_effect(VAL1_2::forall_effect *e) {
        ROS_ERROR("KCL: (%s) Not yet implemented forall effects in intial state parser.",
                  ros::this_node::getName().c_str());
    }

    void VALVisitorProblem::visit_cond_effect(VAL1_2::cond_effect *e) {
        ROS_ERROR("KCL: (%s) Not yet implemented conditional effects in intial state parser.",
                  ros::this_node::getName().c_str());
    }
    ...
    void VALVisitorProblem::visit_comparison(VAL1_2::comparison *c) {
        xyz_knowledge_msgs::KnowledgeItem item;
        item.knowledge_type = xyz_knowledge_msgs::KnowledgeItem::INEQUALITY;
        item.is_negative = problem_cond_neg;
    ...
    void VALVisitorProblem::visit_metric_spec(VAL1_2::metric_spec *s) {
        metric.knowledge_type = xyz_knowledge_msgs::KnowledgeItem::EXPRESSION;
        // parse expression
        last_expr.tokens.clear();
        s->expr->visit(this);
        ...
        // parse optimization
        switch (s->opt) {
            case VAL1_2::E_MINIMIZE:
                metric.optimization = "minimize";
                break;
            case VAL1_2::E_MAXIMIZE:
                metric.optimization = "maximize";
                break;
        }
    }
    ...
    void VALVisitorProblem::visit_plus_expression(VAL1_2::plus_expression *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        base.op = xyz_knowledge_msgs::ExprBase::ADD;
    ...
    void VALVisitorProblem::visit_minus_expression(VAL1_2::minus_expression *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        base.op = xyz_knowledge_msgs::ExprBase::SUB;
        last_expr.tokens.push_back(base);
    ...
    void VALVisitorProblem::visit_mul_expression(VAL1_2::mul_expression *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        base.op = xyz_knowledge_msgs::ExprBase::MUL;
        last_expr.tokens.push_back(base);
    ...
    void VALVisitorProblem::visit_div_expression(VAL1_2::div_expression *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::OPERATOR;
        base.op = xyz_knowledge_msgs::ExprBase::DIV;
        last_expr.tokens.push_back(base);
    ...
    void VALVisitorProblem::visit_uminus_expression(VAL1_2::uminus_expression *s) {
        ...
        base.expr_type = xyz_knowledge_msgs::ExprBase::CONSTANT;
        base.constant = 0;
        last_expr.tokens.push_back(base);
    ...
    void VALVisitorProblem::visit_special_val_expr(VAL1_2::special_val_expr *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::SPECIAL;
        switch (s->getKind()) {
            case VAL1_2::E_HASHT:
                base.special_type = xyz_knowledge_msgs::ExprBase::HASHT;
                break;
            case VAL1_2::E_DURATION_VAR:
                base.special_type = xyz_knowledge_msgs::ExprBase::DURATION;
                break;
            case VAL1_2::E_TOTAL_TIME:
                base.special_type = xyz_knowledge_msgs::ExprBase::TOTAL_TIME;
                break;
        }
        last_expr.tokens.push_back(base);
    }
    ...
    void VALVisitorProblem::visit_func_term(VAL1_2::func_term *s) {
        xyz_knowledge_msgs::ExprBase base;
        base.expr_type = xyz_knowledge_msgs::ExprBase::FUNCTION;
        ...
        for (VAL1_2::func_decl_list::const_iterator fit = domain->functions->begin();
             fit != domain->functions->end(); fit++) {
